...
export default function AboutSection() {
  return (
    <div className={`${Classes.AboutMain} AboutWrapper`}>
          ...
          <div className={Classes.ContentArea}>
            ...
            <div className={Classes.desc}>
              <p>
                ...
                Tristique pellentesque eu sit nisi, potenti ante purus
                vestibulum nibh. Tellus consequat, cum nam bibendum elementum
                porta scelerisque eleifend felis. Facilisis.
              </p>
            </div>
            <ul>
